...
!function(t, e) {
    ...
    var x = {
                ...
                if (o.globals.dataChanged)
                    if (this.dynamicAnim) {
                        ...
                        for (var T = 0; T < o.globals.collapsedSeries.length; T++)
                            o.globals.collapsedSeries[T].index === s && (z = 1,
                            a = 0);
                        0 === t && 0 === e && (a = 0),
                        h.animateCircle(v, {
                            cx: k,
        ...
        return a(t, [{
            ...
            value: function(t) {
                ...
                if (!(Array.isArray(e.config.dataLabels.enabledOnSeries) && e.config.dataLabels.enabledOnSeries.indexOf(n) < 0)) {
                    ...
                    if ("bar" !== e.config.chart.type && "rangeBar" !== e.config.chart.type || !e.config.plotOptions.bar.distributed || (x = e.globals.dataLabels.style.colors[r]),
                    f.drawnextLabel) {
                        var b = i.drawText({
                            width: 100,
        ...
        return a(t, [{
            ...
            value: function(t, e) {
                ...
                o++) {
                    ...
                    }), z = 0, T = i.globals.dataPoints; z < i.globals.dataPoints; z++,
                    T--) {
            ...
            value: function(t) {
                ...
                void 0 !== u && void 0 !== f && (L.attr("data-range-y1", u),
            ...
            value: function() {
                var t, e, i, a, s, n, r, o, l = this.w, h = l.globals.dataPoints;
                return this.isTimelineBar && (h = l.globals.labels.length),
                this.isHorizontal ? (s = (i = l.globals.gridHeight / h) / this.seriesLen,
            ...
            value: function(t) {
                var e = t.x
                  ...
                  , m = e + parseFloat(c * u)
                  , v = i + parseFloat(h * u);
                f.globals.isXNumeric && !f.globals.isBarHorizontal && (m = e + parseFloat(c * (u + 1)),
                ...
                void 0 !== d && this.isTimelineBar && (v = d,
                w = d);
                var C = A.offsetX
                  , L = A.offsetY
                  , P = {
                ...
                return f.config.dataLabels.enabled && (P = x.getTextRects(f.globals.yLabelFormatters[0](f.globals.maxY), parseFloat(A.style.fontSize))),
                k = this.isHorizontal ? this.calculateBarsDataLabelsPosition({
                    x: e,
                    y: i,
                    i: n,
                    j: r,
      ...
      , Y = function() {
        ...
        return a(t, [{
            ...
            key: "pieClicked",
            value: function(t) {
                var e, i = this.w, a = this.w.globals.radialSize + (i.config.plotOptions.pie.expandOnClick ? 4 : 0), s = i.globals.dom.Paper.select(".apexcharts-".concat(i.config.chart.type.toLowerCase(), "-slice-").concat(t)).members[0], n = s.attr("d");
      ...
      , D = function(t) {
        ...
        a(i, [{
            ...
            value: function(t) {
                var e, i, a = t.indexes, s = (t.x,
                t.y), n = t.y1, r = t.y2, o = t.yDivision, l = t.pathTo, h = t.pathFrom, c = t.barHeight, d = t.barYPosition, u = t.zeroW, g = this.w, f = new p(this.ctx), x = (a.i,
                a.j), b = a.realIndex;
                ...
                var m = Math.abs(i - e);
                return l = f.move(e, d) + f.line(i, d) + f.line(i, d + c) + f.line(e, d + c) + f.line(e, d),
      ...
      , W = function() {
        ...
        return a(t, [{
            ...
            value: function() {
                ...
                e.globals.invertedTimelineLabels.length && (this.timescaleLabels = e.globals.invertedTimelineLabels.slice());
            ...
            value: function(t, e, i) {
                ...
                for (var d = this.xyRatios.zRatio, g = this.xyRatios.xRatio, f = this.xyRatios.baseLineY, x = [], b = [], m = 0, v = 0; v < t.length; v++) {
                    ...
                    var M = a.globals.padHorizontal + m
                      , I = 1;
                    a.globals.isXNumeric && a.globals.seriesX.length > 0 && (M = (a.globals.seriesX[A][0] - a.globals.minX) / g),
                    P.push(M);
                    var X = void 0
                      , Y = void 0
                      , F = void 0
                    ...
                    null === t[v][0]) {
                        ...
                        X = s.move(_, j),
                        Y = s.move(_, E) + s.line(_, j);
                    if (F = s.move(-1, T) + s.line(-1, T),
                    ...
                    for (var $ = a.globals.dataPoints > 1 ? a.globals.dataPoints - 1 : a.globals.dataPoints, J = 0; J < $; J++) {
                        ...
                        a.config.chart.stacked ? (U = v > 0 && a.globals.collapsedSeries.length < a.config.series.length - 1 ? b[v - 1][J + 1] : T,
                        I = void 0 === t[v][J + 1] || null === t[v][J + 1] ? U - K / c[this.yaxisIndex] + 2 * (this.isReversed ? K / c[this.yaxisIndex] : 0) : U - t[v][J + 1] / c[this.yaxisIndex] + 2 * (this.isReversed ? t[v][J + 1] / c[this.yaxisIndex] : 0)) : I = void 0 === t[v][J + 1] || null === t[v][J + 1] ? T - K / c[this.yaxisIndex] + 2 * (this.isReversed ? K / c[this.yaxisIndex] : 0) : T - t[v][J + 1] / c[this.yaxisIndex] + 2 * (this.isReversed ? t[v][J + 1] / c[this.yaxisIndex] : 0),
                        P.push(M),
                        S.push(I);
                        ...
                        Y = tt.areaPath,
                        X = tt.linePath,
                        this.appendPathFrom && (F += s.line(M, T),
                        R += s.line(M, T));
      ...
      , j = function() {
        ...
        return a(t, [{
            ...
            value: function(t, e, i) {
                ...
                n.logarithmic && r > 5 ? (a.allSeriesCollapsed = !1,
                a.yAxisScale[t] = this.logarithmicScale(t, e, i, n.tickAmount ? n.tickAmount : Math.floor(Math.log10(i)))) : i !== -Number.MAX_VALUE && u.isNumber(i) ? (a.allSeriesCollapsed = !1,
                void 0 === n.min && void 0 === n.max || n.forceNiceScale ? a.yAxisScale[t] = this.niceScale(e, i, r, t, n.tickAmount ? n.tickAmount : r < 5 && r > 1 ? r + 1 : 5) : a.yAxisScale[t] = this.linearScale(e, i, n.tickAmount)) : a.yAxisScale[t] = this.linearScale(0, 5, 5)
            }
        }, {
        ...
        return a(t, [{
            ...
            value: function(t) {
                ...
                var l = n.series
                  , h = l
                  , c = l;
                "candlestick" === s.chart.type ? (h = n.seriesCandleL,
                c = n.seriesCandleH) : n.isRangeData && (h = n.seriesRangeStart,
                c = n.seriesRangeEnd);
                for (var d = t; d < a; d++) {
                    n.dataPoints = Math.max(n.dataPoints, l[d].length);
                    for (var g = 0; g < n.series[d].length; g++) {
                        var f = l[d][g];
                        null !== f && u.isNumber(f) ? (r = Math.max(r, c[d][g]),
                        e = Math.min(e, h[d][g]),
                        i = Math.max(i, h[d][g]),
                        "candlestick" === this.w.config.chart.type && (r = Math.max(r, n.seriesCandleO[d][g]),
                        r = Math.max(r, n.seriesCandleH[d][g]),
                        r = Math.max(r, n.seriesCandleL[d][g]),
                        i = r = Math.max(r, n.seriesCandleC[d][g])),
                        u.isFloat(f) && (f = u.noExponents(f),
                        n.yValueDecimal = Math.max(n.yValueDecimal, f.toString().split(".")[1].length)),
                        o > h[d][g] && h[d][g] < 0 && (o = h[d][g])) : n.hasNullValues = !0
                    }
                }
            ...
            value: function() {
                ...
                if (!t.globals.isBarHorizontal || this.isTimelineBar) {
                    ...
                    t.config.grid.xaxis.lines.show || t.config.xaxis.axisTicks.show) {
                        var h, c = t.globals.padHorizontal, d = t.globals.gridHeight;
                        if (t.globals.timelineLabels.length || t.globals.invertedTimelineLabels.length)
                            for (var u = 0; u < r; u++) {
                                if (c = this.xaxisLabels[u].position,
                    ...
                    if (r = o,
                    t.config.grid.xaxis.lines.show || t.config.xaxis.axisTicks.show)
                        for (var L, P = t.globals.padHorizontal, z = t.globals.gridHeight, T = 0; T < r + 1 && (L = P = P + t.globals.gridWidth / r + .3,
                        T !== r - 1); T++) {
                            if (t.config.grid.xaxis.lines.show) {
                ...
                return this.isTimelineBar && (o = t.globals.labels.length),
    ...
    function() {
        ...
        function a(t) {
            ...
            case "A":
                t = (e = function(t, e) {
                    var i, a, s, n, r, o, l, h, c, d, u, g, f, p, x, b, m, v, y, w, k, A, S, C, L, P, z = Math.abs(e[1]), T = Math.abs(e[2]), E = e[3] % 360, M = e[4], I = e[5], X = e[6], Y = e[7], F = new SVG.Point(t), R = new SVG.Point(X,Y), D = [];
                    ...
                    (a = i.x * i.x / (z * z) + i.y * i.y / (T * T)) > 1 && (a = Math.sqrt(a),
                    z *= a,
                    T *= a);
                    s = (new SVG.Matrix).rotate(E).scale(1 / z, 1 / T).rotate(-E),
                    F = F.transform(s),
                    R = R.transform(s),
                    n = [R.x - F.x, R.y - F.y],
                    o = n[0] * n[0] + n[1] * n[1],

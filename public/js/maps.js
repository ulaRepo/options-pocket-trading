...
am4internal_webpackJsonp(["cc1e"], {
    QJ7E: function(t, e, n) {
        ...
        var mt, yt, bt, Pt, St, _t, Mt, xt, jt, Ot, wt = m(), Lt = {
            ...
            polygonEnd: function() {
                ...
                Lt.lineEnd = Tt,
                nt < 0 ? (mt = -(bt = 180),
                yt = -(Pt = 90)) : wt > S ? Pt = 90 : wt < -S && (yt = -90),
                Ot[0] = mt,
                Ot[1] = bt
            },
            sphere: function() {
        ...
        function Et(t, e) {
            ...
            if (xt) {
                ...
                c ^ (u * St < s && s < u * t) ? (o = r[1] * w) > Pt && (Pt = o) : c ^ (u * St < (s = (s + 360) % 360 - 180) && s < u * t) ? (o = -r[1] * w) < yt && (yt = o) : (e < yt && (yt = e),
                e > Pt && (Pt = e)),
                c ? t < St ? zt(mt, t) > zt(mt, bt) && (bt = t) : zt(t, bt) > zt(mt, bt) && (mt = t) : bt >= mt ? (t < mt && (mt = t),
                t > bt && (bt = t)) : t > St ? zt(mt, t) > zt(mt, bt) && (bt = t) : zt(t, bt) > zt(mt, bt) && (mt = t)
            } else
                jt.push(Ot = [mt = t, bt = t]);
            e < yt && (yt = e),
            e > Pt && (Pt = e),
        ...
        var At, Rt, kt, Bt, Wt, Ht, Zt, qt, Xt, Yt, Ut, Jt, Kt, Qt, $t, te, ee = function(t) {
            ...
            n = jt.length) {
                ...
                e = 1,
                o = [i = jt[0]]; e < n; ++e)
                    Vt(i, (r = jt[e])[0]) || Vt(i, r[1]) ? (zt(i[0], r[1]) > zt(i[0], i[1]) && (i[1] = r[1]),
                    zt(r[0], i[1]) > zt(i[0], i[1]) && (i[0] = r[0])) : o.push(i = r);
                for (a = -1 / 0,
                e = 0,
            ...
            return jt = Ot = null,
            mt === 1 / 0 || yt === 1 / 0 ? [[NaN, NaN], [NaN, NaN]] : [[mt, yt], [bt, Pt]]
        }, ne = {
            sphere: H,
            point: ie,
            lineStart: oe,
        ...
        var fe = function(t) {
            At = Rt = kt = Bt = Wt = Ht = Zt = qt = Xt = Yt = Ut = 0,
            et(t, ne);
            var e = Xt
              , n = Yt
              , i = Ut
            ...
            n = Bt,
            i = Wt),
            (r = e * e + n * n + i * i) < _) ? [NaN, NaN] : [I(n, e) * w, B(i / A(r)) * w]
        }
          , de = function(t) {
            return function() {
                return t
        ...
        var Se = function(t) {
            function e(e) {
                return (e = t(e[0] * L, e[1] * L))[0] *= w,
                e[1] *= w,
                e
            }
            return t = me(t[0] * L, t[1] * L, t.length > 2 ? t[2] * L : 0),
            e.invert = function(e) {
                return (e = t.invert(e[0] * L, e[1] * L))[0] *= w,
                e[1] *= w,
                e
            }
            ,
        ...
        var xe = function() {
            ...
            return a.center = function(t) {
                return arguments.length ? (n = "function" == typeof t ? t : de([+t[0], +t[1]]),
                a) : n
            }
            ,
            a.radius = function(t) {
                return arguments.length ? (i = "function" == typeof t ? t : de(+t),
                a) : i
            }
            ,
            a.precision = function(t) {
                return arguments.length ? (r = "function" == typeof t ? t : de(+t),
                a) : r
            }
            ,
            a
        ...
        var Te = function(t, e) {
            ...
            for (var s = 0, c = t.length; s < c; ++s)
                if (h = (l = t[s]).length)
                    for (var l, h, p = l[h - 1], f = Ie(p), d = p[1] / 2 + j, g = F(d), v = T(d), m = 0; m < h; ++m,
                    f = b,
                    g = _,
                    v = w,
                    p = y) {
            ...
            return function(r) {
                var o, a, u, s = e(r), c = je(), l = e(c), h = !1, p = {
                    ...
                    polygonEnd: function() {
                        ...
                        h = !0),
                        Le(a, Re, t, n, r)) : t && (h || (r.polygonStart(),
                        h = !0),
                        r.lineStart(),
                        n(null, null, 1, r),
                        r.lineEnd()),
        ...
        var ke = Ve(function() {
            ...
            return {
                ...
                point: function(o, a) {
                    var u = o > 0 ? M : -M
                      , s = C(o - n);
                    C(s - M) < S ? (t.point(n, i = (i + a) / 2 > 0 ? x : -x),
                    t.point(r, i),
                    t.lineEnd(),
                    t.lineStart(),
                    t.point(u, i),
                    t.point(o, i),
                    e = 0) : r !== u && s >= M && (C(n - r) < S && (n -= r * S),
                    C(o - u) < S && (o -= u * S),
                    i = function(t, e, n, i) {
                        var r, o, a = F(t - n);
        ...
        var Be = function(t) {
            ...
            function a(t, n, i) {
                ...
                if (!(v < 0)) {
                    ...
                    x = j,
                    j = b),
                    w || O < S ? w ? x + j > 0 ^ y[1] < (C(y[0] - P) < S ? x : j) : x <= y[1] && y[1] <= j : O > M ^ (P <= y[0] && y[0] <= _)) {
                        var L = gt(f, (-d + m) / g);
                        return dt(L, p),
                        [y, lt(L)]
                    }
            ...
            return Ve(o, function(t) {
                ...
                return {
                    ...
                    point: function(h, p) {
                        ...
                        g !== s && (!(f = a(e, d)) || Oe(e, f) || Oe(d, f)) && (d[0] += S,
                        d[1] += S,
                        g = o(d[0], d[1])),
                        g !== s)
                            l = 0,
        ...
        function hn(t, e) {
            for (var n, i, r, o = 0, a = t.length; o < a; o++) {
                if (0 === (i = an(t[o], e)))
                    return !0;
                if (o > 0 && (r = an(t[o], t[o - 1])) > 0 && n <= r && i <= r && (n + i - r) * (1 - Math.pow((n - i) / r, 2)) < _ * r)
                    return !0;
                n = i
            }
            return !1
        ...
        var Vn, An, Rn, kn, Bn = {
            ...
            result: function() {
                ...
                return Wn = Hn = Zn = qn = Xn = Yn = Un = Jn = Kn = 0,
                t
            }
        };
        function $n(t, e) {
                ...
                function n(i, r, o, a, u, s, c, l, h, p, f, d, g, v) {
                    ...
                    if (b > 4 * e && g--) {
                        var P = a + p
                          ...
                          , G = E - r
                          , D = y * T - m * G;
                        (D * D / b > e || C((m * T + y * G) / b - .5) > .3 || a * p + u * f + s * d < Ti) && (n(i, r, o, a, u, s, L, E, O, P /= x, _ /= x, M, g, v),
                        v.point(L, E),
        ...
        function Fi(t) {
            var e, n, i, r, o, a, u, s, c, l, h = 150, p = 480, f = 250, d = 0, g = 0, v = 0, m = 0, y = 0, b = 0, P = null, S = ke, _ = null, M = jn, x = .5;
            function j(t) {
            ...
            j.clipAngle = function(t) {
                return arguments.length ? (S = +t ? Be(P = t * L) : (P = null,
                ke),
                E()) : P * w
            }
            ,
            j.clipExtent = function(t) {
                return arguments.length ? (M = null == t ? (_ = i = r = o = null,
                jn) : qe(_ = +t[0][0], i = +t[0][1], r = +t[1][0], o = +t[1][1]),
                E()) : null == _ ? null : [[_, i], [r, o]]
            }
            ,
            j.scale = function(t) {
            ...
            ,
            j.center = function(t) {
                return arguments.length ? (d = t[0] % 360 * L,
                g = t[1] % 360 * L,
                C()) : [d * w, g * w]
            }
            ,
            j.rotate = function(t) {
                return arguments.length ? (v = t[0] % 360 * L,
                m = t[1] % 360 * L,
            ...
            ,
            j.angle = function(t) {
                return arguments.length ? (b = t % 360 * L,
                C()) : b * w
            }
            ,
            j.precision = function(t) {
                return arguments.length ? (a = Gi(u, x = t * t),
                E()) : A(x)
            }
            ,
        ...
        var Bi = function() {
            var t, e, n, i, r, o, a = ki(), u = Ri().rotate([154, 0]).center([-2, 58.5]).parallels([55, 65]), s = Ri().rotate([157, 0]).center([-3, 19.9]).parallels([8, 18]), c = {
                point: function(t, e) {
                    o = [t, e]
                }
            };
            ...
            l.translate = function(t) {
                ...
                i = u.translate([o - .307 * e, l + .201 * e]).clipExtent([[o - .425 * e + S, l + .12 * e + S], [o - .214 * e - S, l + .234 * e - S]]).stream(c),
                r = s.translate([o - .205 * e, l + .212 * e]).clipExtent([[o - .214 * e + S, l + .166 * e + S], [o - .115 * e - S, l + .234 * e - S]]).stream(c),
                h()
            }
            ,
        ...
        lr.invert = function(t, e) {
            for (var n, i = e, r = i * i, o = r * r * r, a = 0; a < 12 && (o = (r = (i -= n = (i * (or + ar * r + o * (ur + sr * r)) - e) / (or + 3 * ar * r + o * (7 * ur + 9 * sr * r))) * i) * r * r,
            !(C(n) < _)); ++a)
                ;
        ...
        var gr = function() {
            ...
            return o = {
                ...
                postclip: function(i) {
                    return arguments.length ? (f = i,
                    p = t = e = n = null,
                    d()) : f
                },
                clipExtent: function(i) {
                    return arguments.length ? (f = null == i ? (p = t = e = n = null,
                    jn) : qe(p = +i[0][0], t = +i[0][1], e = +i[1][0], n = +i[1][1]),
                    d()) : null == p ? null : [[p, t], [e, n]]
                },
                scale: function(t) {
                    return arguments.length ? (h = dr((a = +t) * c, a * l, u, s),
                    d()) : a
                },
                translate: function(t) {
                    return arguments.length ? (h = dr(a * c, a * l, u = +t[0], s = +t[1]),
                    d()) : [u, s]
                },
                reflectX: function(t) {
                    return arguments.length ? (h = dr(a * (c = t ? -1 : 1), a * l, u, s),
                    d()) : c < 0
                },
                reflectY: function(t) {
                    return arguments.length ? (h = dr(a * c, a * (l = t ? -1 : 1), u, s),
                    d()) : l < 0
                },
        ...
        var Or = n("C6dT")
          , wr = function(t) {
            ...
            e.prototype.showTooltip = function(e) {
                ...
                return n && "always" == this.showTooltipOn && !this.series.chart.events.has("mappositionchanged", this.handleTooltipMove, this) && this.series.chart.events.on("mappositionchanged", this.handleTooltipMove, this),
                n
            }
            ,
          ...
          , Yr = function(t) {
            ...
            e.prototype.validate = function() {
                ...
                this.mapPolygons.each(function(t) {
                    t.validate(),
                    t.zIndex || t.propertyFields.zIndex || (t.zIndex = 1e6 - t.boxArea)
                })
            }
            ,
        ...
        var Jr = n("FzPm")
          ...
          , $r = function(t) {
            ...
            Object.defineProperty(e.prototype, "series", {
                get: function() {
                    return this._series || (this._series = new Hr.b,
        ...
        function no(t) {
            var e = ro(t.longitude)
              ...
              , i = ro(t.latitude);
            return Math.abs(i) > 90 && (e = ro(e + 180)),
            t.longitude = e,
            t.latitude = n,
            t
        }
        ...
        var co = n("Rnbi")
          ...
          , po = function(t) {
            ...
            e.prototype.validate = function() {
                ...
                if (this.multiLine) {
                    if (this.shortestDistance)
                        e.projection.d3Projection.precision(.1),
            ...
            Object.defineProperty(e.prototype, "lineObjects", {
                get: function() {
                    return this._lineObjects || (this._lineObjects = new Hr.e(new ao),
            ...
            e.prototype.getTooltipX = function() {
                ...
                return t instanceof ho.a || (t = Object(ho.c)(50)),
        ...
        var bo = n("zhwk")
          ...
          , So = function(t) {
            function e() {
                ...
                e._disposers.push(Object(bo.b)().body.events.on("keyup", function(t) {
            ...
            e.prototype.handlePanDown = function(t) {
                ...
                e.x > 0 && e.y > 0 && e.x < this.svgContainer.width && e.y < this.svgContainer.height && (this._downPointOrig = Zr.documentPointToSprite(t.pointer.point, this.seriesContainer),
            ...
            e.prototype.updateExtremes = function() {
                var t, e, n, i;
                this.series.each(function(r) {
                    r.ignoreBounds || r instanceof yo && r.fitExtent || ((r.north > e || !g.isNumber(e)) && (e = r.north),
                ...
                var r = []
                  , o = !1;
                this.series.each(function(t) {
                    t instanceof yo && !t.fitExtent && (r = t.getFeatures(),
                    o = !0)
                }),
            ...
            e.prototype.zoomToGeoPoint = function(t, e, n, i, r) {
                ...
                t && g.isNumber(t.longitude) && g.isNumber(t.latitude)) {
                    ...
                    if (a) {
                        ...
                        return !r && e < this.zoomLevel && this.centerMapOnZoomOut && e < 1.5 && (c = this.innerWidth / 2 - (this.seriesMaxLeft + (this.seriesMaxRight - this.seriesMaxLeft) / 2) * e * this.scaleRatio,
                        l = this.innerHeight / 2 - (this.seriesMaxTop + (this.seriesMaxBottom - this.seriesMaxTop) / 2) * e * this.scaleRatio),
            ...
            Object.defineProperty(e.prototype, "deltaLongitude", {
                ...
                set: function(t) {
                    this.setPropertyValue("deltaLongitude", ro(t)) && (this.rotateMap(),
        ...
        ca.invert = function(t, e) {
            if (!(t * t + 4 * e * e > Uo * Uo + Xo)) {
                var n = t
                  ...
                  , r = 25;
                do {
                    var o, a = Zo(n), u = Zo(n / 2), s = Fo(n / 2), c = Zo(i), l = Fo(i), h = Zo(2 * i), p = c * c, f = l * l, d = u * u, g = 1 - f * s * s, v = g ? oa(l * s) * aa(o = 1 / g) : o = 0, m = 2 * v * l * u - t, y = v * c - e, b = o * (f * d + v * l * s * p), P = o * (.5 * a * h - 2 * v * c * u), S = .25 * o * (h * u - v * c * f * a), _ = o * (p * s + v * d * l), M = P * S - _ * b;
                    if (!M)
                        break;
                    var x = (y * P - m * _) / M
                      , j = (m * S - y * b) / M;
        ...
        Aa(2.8284, -1.6988, .75432, -.18071, 1.76003, -.38914, .042555),
        Aa(2.583819, -.835827, .170354, -.038094, 1.543313, -.411435, .082742),
        Aa(5 / 6 * Uo, -.62636, -.0344, 0, 1.3493, -.05524, 0, .045);
        function Ra(t, e) {
            var n = t * t
              , i = e * e;
        ...
        function ka(t, e) {
            ...
            var s = function(t, e) {
                if (e === Jo)
                    return [0, 0];
                var n, i, r = Zo(e), o = r * r, a = o * o, u = 1 + a, s = 1 + 3 * a, c = 1 - a, l = ra(1 / aa(u)), h = c + o * u * l, p = (1 - r) / h, f = aa(p), d = p * u, g = aa(d), v = f * c;
                if (0 === t)
                    return [0, -(v + o * g)];
                var m, y = Fo(e), b = 1 / y, P = 2 * r * y, S = (-h * y - (-3 * o + l * s) * P * (1 - r)) / (h * h), _ = -b * P, M = -b * (o * u * S + p * s * P), x = -2 * b * (c * (.5 * S / f) - 2 * o * f * P), j = 4 * t / Uo;
                if (t > .222 * Uo || e < Uo / 4 && t > .175 * Uo) {
                    if (n = (v + o * aa(d * (1 + a) - v * v)) / (1 + a),
                    t > Uo / 4)
                        return [n, n];
                    var O = n
                      , w = .5 * n;
        ...
        Ha.invert = function(t, e) {
            var n = ($o - 1) / ($o + 1)
              ...
              , r = function(t, e, n) {
                var i, r, o;
                return t ? (i = Ba(t, n),
                e ? (o = (r = Ba(e, 1 - n))[1] * r[1] + n * i[0] * i[0] * r[0] * r[0],
                [[i[0] * r[2] / o, i[1] * i[2] * r[0] * r[1] / o], [i[1] * r[1] / o, -i[0] * i[2] * r[0] * r[2] / o], [i[2] * r[1] * r[2] / o, -n * i[0] * i[1] * r[0] / o]]) : [[i[0], 0], [i[1], 0], [i[2], 0]]) : [[0, (r = Ba(e, 1 - n))[0] / r[1]], [1 / r[1], 0], [r[2] / r[1], 0]]
            }(.5 * Wa(Jo, i * i) - e, -t, i * i)
              , o = function(t, e) {
        ...
        ;
        function Ya(t, e) {
            return Do(e) > Za ? ((t = ya(t, e))[1] -= e > 0 ? qa : -qa,
            t) : _a(t, e)
        }
        ...
        ;
        function ou(t, e) {
            for (var n, i = (1 + Qo) * Zo(e), r = e, o = 0; o < 25 && (r -= n = (Zo(r / 2) + Zo(r) - i) / (.5 * Fo(r / 2) + Fo(r)),
            !(Do(n) < Xo)); o++)
                ;
        ...
        ;
        function au(t, e) {
            for (var n, i = aa(6 / (4 + Uo)), r = (1 + Uo / 4) * Zo(e), o = e / 2, a = 0; a < 25 && (o -= n = (o / 2 + Zo(o) - r) / (.5 + Fo(o)),
            !(Do(n) < Xo)); a++)
                ;
        ...
        au.invert = function(t, e) {
            var n = aa(6 / (4 + Uo))
              , i = e / n;
            return Do(Do(i) - Jo) < Xo && (i = i < 0 ? -Jo : Jo),
            [1.5 * t / (n * (.5 + Fo(i))), ra((i / 2 + Zo(i)) / (1 + Uo / 4))]
        }
        ;
        function uu(t, e) {
            var n = e * e
        ...
        function xu(t, e) {
            var n, i = Bo(18, 36 * Do(e) / Uo), r = Ao(i), o = i - r, a = (n = Mu[r])[0], u = n[1], s = (n = Mu[++r])[0], c = n[1], l = (n = Mu[Bo(19, ++r)])[0], h = n[1];
        ...
        Du.invert = function(t, e) {
            var n = t
              ...
              , r = 25;
            do {
                var o, a = Fo(i), u = Zo(i), s = Zo(2 * i), c = u * u, l = a * a, h = Zo(n), p = Fo(n / 2), f = Zo(n / 2), d = f * f, g = 1 - l * p * p, v = g ? oa(a * p) * aa(o = 1 / g) : o = 0, m = .5 * (2 * v * a * f + n / Jo) - t, y = .5 * (v * u + i) - e, b = .5 * o * (l * d + v * a * p * c) + .5 / Jo, P = o * (h * s / 4 - v * u * f), S = .125 * o * (s * f - v * u * l * h), _ = .5 * o * (c * p + v * d * a) + .5, M = P * S - _ * b, x = (y * P - m * _) / M, j = (m * S - y * b) / M;
                n -= x,
                i -= j
            } while ((Do(x) > Xo || Do(j) > Xo) && --r > 0);
            return [n, i]
        ...
        var Wu = function(t) {
            function e() {
                var e = t.call(this) || this;
                return e.d3Projection = hr(),
                e
            }
            return Object(c.c)(e, t),
            e
        }(Ur);
        d.c.registeredClasses.EqualEarth = Wu,
        window.am4maps = a
    },
    QaCB: function(t, e, n) {
        "use strict";
            ...
            _down: function(t) {
                for (var e = this.data, n = this.compare, i = this.length >> 1, r = e[t]; t < i; ) {
                    var o = 1 + (t << 1)
                      , a = o + 1
                      , u = e[o];
                    if (a < this.length && n(e[a], u) < 0 && (o = a,
                    u = e[a]),
                    n(u, r) >= 0)
                        break;
                    e[t] = u,
    ...
    U8r1: function(t, e, n) {
        ...
        function r(t, e, n) {
            ...
            return n && (console.log("num probes: " + S),
